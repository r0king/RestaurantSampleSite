...
var Y2 = class {
  constructor(t2, e, n, s) {
    this.h = t2, this.l = e, this.m = n, this.g = s, this.type = "FirstParty", this.user = C2.FIRST_PARTY, this.p = /* @__PURE__ */ new Map();
  }
  I() {
...
var bt = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";
var Pt = class {
  constructor() {
...
var Vt = class {
  ...
  next(t2, e) {
    return this.callbackAttached && L2(), this.callbackAttached = true, this.isDone ? this.error ? this.wrapFailure(e, this.error) : this.wrapSuccess(t2, this.result) : new Vt((n, s) => {
...
var St = class {
  constructor(t2, e) {
    this.action = t2, this.transaction = e, this.aborted = false, this.P = new j(), this.transaction.oncomplete = () => {
      this.P.resolve();
    }, this.transaction.onabort = () => {
      e.error ? this.P.reject(new xt(t2, e.error)) : this.P.resolve();
    }, this.transaction.onerror = (e2) => {
      const n = Ft(e2.target.error);
      this.P.reject(new xt(t2, n));
    };
  }
  ...
  abort(t2) {
    t2 && this.P.reject(t2), this.aborted || (O2("SimpleDb", "Aborting transaction:", t2 ? t2.message : "Client-initiated abort"), this.aborted = true, this.transaction.abort());
  }
  V() {
...
var Dt = class {
  constructor(t2, e, n) {
    ...
    12.2 === Dt.D(getUA()) && F2("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
  }
  static delete(t2) {
    return O2("SimpleDb", "Removing database:", t2), Mt(window.indexedDB.deleteDatabase(t2)).toPromise();
  }
  static C() {
    ...
    if (Dt.N())
      return true;
    const t2 = getUA(), e = Dt.D(t2), n = 0 < e && e < 10, s = Dt.k(t2), i = 0 < s && s < 4.5;
  ...
  async F(t2) {
    return this.db || (O2("SimpleDb", "Opening database:", this.name), this.db = await new Promise((e, n) => {
      ...
      s.onsuccess = (t3) => {
        ...
        "VersionError" === s2.name ? n(new Q2(G.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : "InvalidStateError" === s2.name ? n(new Q2(G.FAILED_PRECONDITION, "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + s2)) : n(new xt(t2, s2));
  ...
  async runTransaction(t2, e, n, s) {
    ...
    for (; ; ) {
      ...
      try {
        ...
        const e2 = St.open(this.db, t2, i ? "readonly" : "readwrite", n), r2 = s(e2).next((t3) => (e2.V(), t3)).catch((t3) => (e2.abort(t3), Vt.reject(t3))).toPromise();
        return r2.catch(() => {
        }), await e2.v, r2;
      } catch (t3) {
        const e2 = t3, n2 = "FirebaseError" !== e2.name && r < 3;
        if (O2("SimpleDb", "Transaction failed with error:", e2.message, "Retrying:", n2), this.close(), !n2)
...
var kt = class {
  ...
  put(t2, e) {
    let n;
    return void 0 !== e ? (O2("SimpleDb", "PUT", this.store.name, t2, e), n = this.store.put(e, t2)) : (O2("SimpleDb", "PUT", this.store.name, "<auto-key>", t2), n = this.store.put(t2)), Mt(n);
  }
  add(t2) {
  ...
  get(t2) {
    return Mt(this.store.get(t2)).next((e) => (void 0 === e && (e = null), O2("SimpleDb", "GET", this.store.name, t2, e), e));
  }
  delete(t2) {
...
var $t = class {
  ...
  nt(t2) {
    O2("IndexBackiller", `Scheduled in ${t2}ms`), this.task = this.asyncQueue.enqueueAfterDelay("index_backfill", t2, async () => {
      this.task = null;
      try {
        O2("IndexBackiller", `Documents written: ${await this.et.st()}`);
      } catch (t3) {
        Nt(t3) ? O2("IndexBackiller", "Ignoring IndexedDB error during index backfill: ", t3) : await vt(t3);
      }
      await this.nt(1);
    });
  }
...
var Bt = class {
  ...
  it(t2, e) {
    ...
    return Vt.doWhile(() => true === i && s > 0, () => this.localStore.indexManager.getNextCollectionGroupToUpdate(t2).next((e2) => {
      if (null !== e2 && !n.has(e2))
        return O2("IndexBackiller", `Processing collection: ${e2}`), this.rt(t2, e2, s).next((t3) => {
          s -= t3, n.add(e2);
        });
      i = false;
    })).next(() => e - s);
  ...
  rt(t2, e, n) {
    return this.localStore.indexManager.getMinOffsetFromCollectionGroup(t2, e).next((s) => this.localStore.localDocuments.getNextDocuments(t2, e, s, n).next((n2) => {
      const i = n2.changes;
      return this.localStore.indexManager.updateIndexEntries(t2, i).next(() => this.ot(s, n2)).next((n3) => (O2("IndexBackiller", `Updating offset: ${n3}`), this.localStore.indexManager.updateCollectionGroup(t2, e, n3))).next(() => i.size);
    }));
  }
  ot(t2, e) {
    let n = t2;
...
function dn(t2) {
  ...
  if (!e.wt)
    if ("F" === e.limitType)
      ...
      e.wt = Oe(e.path, e.collectionGroup, t3, e.filters, e.limit, n, s);
    }
  return e.wt;
}
function _n(t2, e, n) {
...
function Tn(t2, e, n) {
  const s = t2.field.isKeyField() ? dt.comparator(e.key, n.key) : function(t3, e2, n2) {
    ...
    return null !== s2 && null !== i ? me(s2, i) : L2();
  }(t2.field, e, n);
  switch (t2.dir) {
    case "asc":
      return s;
...
function Pn(t2, e, n) {
  return t2 instanceof Sn ? function(t3, e2) {
    ...
    const n2 = Vn(t3, e2), s = Mn(n2) + Mn(t3.yt);
    return Te(n2) && Te(t3.yt) ? An(s) : En(t3.It, s);
  }(t2, e);
}
function vn(t2, e, n) {
...
var us = new Gt(dt.comparator);
function cs() {
  return us;
}
var as = new Gt(dt.comparator);
function hs(...t2) {
  let e = as;
  for (const n of t2)
    e = e.insert(n.key, n);
...
var ws = new Gt(dt.comparator);
var ms = new Wt(dt.comparator);
function gs(...t2) {
  let e = ms;
  for (const n of t2)
    e = e.add(n);
...
var Ps = class {
  ...
  te(t2) {
    ...
    const s = new Is(t2, e, this.Kt, this.Ut, n);
...
function Hs(t2, e) {
  const n = e.currentDocument ? function(t3) {
    ...
    if ("setToServerValue" in e3)
      U2("REQUEST_TIME" === e3.setToServerValue), n2 = new Sn();
      ...
      "increment" in e3 ? n2 = new kn(t3, e3.increment) : L2();
...
function Js(t2, e) {
  return t2 && t2.length > 0 ? (U2(void 0 !== e), t2.map((t3) => function(t4, e2) {
...
var gi = {};
var yi = ["prefixPath", "collectionGroup", "readTime", "documentId"];
var pi = ["prefixPath", "collectionGroup", "documentId"];
var Ii = ["collectionGroup", "readTime", "prefixPath", "documentId"];
var Ti = ["canonicalId", "targetId"];
var Ei = ["targetId", "path"];
var Ai = ["path", "targetId"];
var Ri = ["collectionId", "parent"];
var bi = ["indexId", "uid"];
var Pi = ["uid", "sequenceNumber"];
var vi = ["indexId", "uid", "arrayValue", "directionalValue", "orderedDocumentKey", "documentKey"];
var Vi = ["indexId", "uid", "orderedDocumentKey"];
var Si = ["userId", "collectionPath", "documentId"];
var Di = ["userId", "collectionPath", "largestBatchId"];
var Ci = ["userId", "collectionGroup", "largestBatchId"];
var xi = [...[...[...[...["mutationQueues", "mutations", "documentMutations", "remoteDocuments", "targets", "owner", "targetGlobal", "targetDocuments"], "clientMetadata"], "remoteDocumentGlobal"], "collectionParents"], "bundles", "namedQueries"];
var Ni = [...xi, "documentOverlays"];
var ki = ["mutationQueues", "mutations", "documentMutations", "remoteDocumentsV14", "targets", "owner", "targetGlobal", "targetDocuments", "clientMetadata", "remoteDocumentGlobal", "collectionParents", "bundles", "namedQueries", "documentOverlays"];
var Mi = ki;
var Oi = [...Mi, "indexConfiguration", "indexState", "indexEntries"];
var Fi = class extends Pt {
  constructor(t2, e) {
...
function Gi(t2, e) {
  let n;
  if (e.document)
    n = Qs(t2.re, e.document, !!e.hasCommittedMutations);
...
function Hi(t2, e) {
  const n = (e.baseMutations || []).map((e2) => Hs(t2.re, e2));
  ...
  const s = e.mutations.map((e2) => Hs(t2.re, e2)), i = ut.fromMillis(e.localWriteTimeMs);
...
function Ji(t2) {
  ...
  let s;
  var i;
  return void 0 !== t2.query.documents ? (U2(1 === (i = t2.query).documents.length), s = dn(un(Us(i.documents[0])))) : s = function(t3) {
    return dn(Zs(t3));
...
function Yi(t2, e) {
  ...
  let i;
  i = Le(e.target) ? Ys(t2.re, e.target) : Xs(t2.re, e.target);
...
function Zi(t2, e) {
  return new Ui(e.largestBatchId, Hs(t2.re, e.overlayMutation));
}
function tr(t2, e) {
...
var rr = class {
  ...
  getOverlay(t2, e) {
    return or(t2).get(tr(this.userId, e)).next((t3) => t3 ? Zi(this.It, t3) : null);
  }
  getOverlays(t2, e) {
    const n = fs();
  ...
  removeOverlaysForBatchId(t2, e, n) {
    ...
    return s.forEach((e2) => {
      ...
      i.push(or(t2).Y("collectionPathOverlayIndex", s2));
    }), Vt.waitFor(i);
  }
  getOverlaysForCollection(t2, e, n) {
    ...
    return or(t2).W("collectionPathOverlayIndex", r).next((t3) => {
      for (const e2 of t3) {
  ...
  ue(t2, e) {
    return or(t2).put(function(t3, e2, n) {
      ...
      return {
        ...
        overlayMutation: zs(t3.re, n.mutation)
      };
...
var Ir = new Uint8Array(0);
var Tr = class {
  constructor(t2, e) {
    this.user = t2, this.databaseId = e, this.Xe = new pr(), this.Ze = new os((t3) => Fe(t3), (t3, e2) => Be(t3, e2)), this.uid = t2.uid || "";
  }
  addToCollectionParentIndex(t2, e) {
    if (!this.Xe.has(e)) {
  ...
  getDocumentsMatchingTarget(t2, e) {
    ...
    return Vt.forEach(this.tn(e), (e2) => this.en(t2, e2).next((t3) => {
      s && (s = !!t3), i.set(e2, t3);
    })).next(() => {
      if (s) {
        let t3 = gs();
        ...
        return Vt.forEach(i, (i2, r) => {
          var o;
          O2("IndexedDbIndexManager", `Using index ${o = i2, `id=${o.indexId}|cg=${o.collectionGroup}|f=${o.fields.map((t4) => `${t4.fieldPath}:${t4.kind}`).join(",")}`} to execute ${Fe(e)}`);
  ...
  rn(t2, e, n, s, i, r, o) {
    ...
    for (let h = 0; h < u; ++h) {
      const u2 = e ? this.on(e[h / c]) : Ir, l2 = this.un(t2, u2, n[h % c], s), f = this.cn(t2, u2, i[h % c], r), d = o.map((e2) => this.un(
        t2,
        u2,
        e2,
        true
  ...
  on(t2) {
    const e = new dr();
    return ur.Te.ce(t2, e.qe(0)), e.$e();
  }
  hn(t2, e) {
    const n = new dr();
    return ur.Te.ce(Ie(this.databaseId, e), n.qe(function(t3) {
      const e2 = mt(t3);
  ...
  sn(t2, e, n) {
    ...
    for (const r of mt(t2)) {
      const t3 = n[i++];
      for (const n2 of s)
        if (this.ln(e, r.fieldPath) && Ee(t3))
          s = this.fn(s, r, t3);
        else {
  ...
  fn(t2, e, n) {
    ...
    for (const t3 of n.arrayValue.values || [])
      for (const n2 of s) {
        const s2 = new dr();
        s2.seed(n2.$e()), ur.Te.ce(t3, s2.qe(e.kind)), i.push(s2);
      }
    return i;
  }
  ln(t2, e) {
  ...
  updateCollectionGroup(t2, e, n) {
    ...
    return this._n(t2).next((t3) => s.W("collectionGroupIndex", IDBKeyRange.bound(e, e)).next((e2) => Vt.forEach(e2, (e3) => i.put(er(e3.indexId, this.user, t3, n)))));
  }
  updateIndexEntries(t2, e) {
    const n = /* @__PURE__ */ new Map();
    return Vt.forEach(e, (e2, s) => {
      const i = n.get(e2.collectionGroup);
      return (i ? Vt.resolve(i) : this.getFieldIndexes(t2, e2.collectionGroup)).next((i2) => (n.set(e2.collectionGroup, i2), Vt.forEach(i2, (n2) => this.wn(t2, e2, n2).next((e3) => {
        const i3 = this.mn(s, n2);
        return e3.isEqual(i3) ? Vt.resolve() : this.gn(t2, s, n2, e3, i3);
      }))));
    });
  }
  yn(t2, e, n, s) {
  ...
  pn(t2, e, n, s) {
    return Ar(t2).delete([s.indexId, this.uid, s.arrayValue, s.directionalValue, this.hn(n, e.key), e.key.path.toArray()]);
  }
  wn(t2, e, n) {
    const s = Ar(t2);
    let i = new Wt(wr);
    ...
    if (null != i) {
      ...
      if (Ee(r))
        for (const i2 of r.arrayValue.values || [])
          n = n.add(new _r(e.indexId, t2.key, this.on(i2), s));
    } else
  ...
  getMinOffset(t2, e) {
    return Vt.mapArray(this.tn(e), (e2) => this.en(t2, e2).next((t3) => t3 || L2())).next(Pr);
  }
};
function Er(t2) {
...
var Cr = class {
  ...
  addMutationBatch(t2, e, n, s) {
    ...
    return r.add({}).next((o) => {
      ...
      const u = new Bi(o, e, n, s), c = function(t3, e2, n2) {
        const s2 = n2.baseMutations.map((e3) => zs(t3.re, e3)), i2 = n2.mutations.map((e3) => zs(t3.re, e3));
        return {
          userId: e2,
          batchId: n2.batchId,
  ...
  lookupMutationBatch(t2, e) {
    return Nr(t2).get(e).next((t3) => t3 ? (U2(t3.userId === this.userId), Hi(this.It, t3)) : null);
  }
  Tn(t2, e) {
    return this.In[e] ? Vt.resolve(this.In[e]) : this.lookupMutationBatch(t2, e).next((t3) => {
      if (t3) {
        const n = t3.keys();
  ...
  getNextMutationBatchAfterBatchId(t2, e) {
    ...
    return Nr(t2).Z({
      ...
      e2.userId === this.userId && (U2(e2.batchId >= n), i = Hi(this.It, e2)), s2.done();
    }).next(() => i);
  }
  ...
  getAllMutationBatches(t2) {
    ...
    return Nr(t2).W("userMutationsIndex", e).next((t3) => t3.map((t4) => Hi(this.It, t4)));
  }
    ...
    return kr(t2).Z({
      ...
      if (o === this.userId && e.path.isEqual(a))
        return Nr(t2).get(c).next((t3) => {
          if (!t3)
            throw L2();
          U2(t3.userId === this.userId), i.push(Hi(this.It, t3));
        });
      r.done();
    }).next(() => i);
  }
  getAllMutationBatchesAffectingDocumentKeys(t2, e) {
    ...
    const s = [];
    return e.forEach((e2) => {
      const i = wi(this.userId, e2.path), r = IDBKeyRange.lowerBound(i), o = kr(t2).Z({
        range: r
      }, (t3, s2, i2) => {
      ...
      s.push(o);
    }), Vt.waitFor(s).next(() => this.En(t2, n));
  }
  ...
  En(t2, e) {
    ...
    return e.forEach((e2) => {
      s.push(Nr(t2).get(e2).next((t3) => {
        if (null === t3)
          throw L2();
        U2(t3.userId === this.userId), n.push(Hi(this.It, t3));
      }));
    }), Vt.waitFor(s).next(() => n);
  }
  removeMutationBatch(t2, e) {
    return Sr(t2.ie, this.userId, e).next((n) => (t2.addOnCommittedListener(() => {
      this.An(e.batchId);
...
var Fr = class {
  ...
  getLastRemoteSnapshotVersion(t2) {
    return this.Vn(t2).next((t3) => ct.fromTimestamp(new ut(t3.lastRemoteSnapshotVersion.seconds, t3.lastRemoteSnapshotVersion.nanoseconds)));
  }
  ...
  removeTargetData(t2, e) {
    return this.removeMatchingKeysForTargetId(t2, e.targetId).next(() => $r(t2).delete(e.targetId)).next(() => this.Vn(t2)).next((e2) => (U2(e2.targetCount > 0), e2.targetCount -= 1, this.Sn(t2, e2)));
  }
  ...
  Vn(t2) {
    return Br(t2).get("targetGlobalKey").next((t3) => (U2(null !== t3), t3));
  }
  Sn(t2, e) {
    return Br(t2).put("targetGlobalKey", e);
  }
  Dn(t2, e) {
    return $r(t2).put(Yi(this.It, e));
  }
  Cn(t2, e) {
    let n = false;
...
var qr = class {
  constructor(t2) {
    this.xn = t2, this.buffer = new Wt(Ur), this.Nn = 0;
  }
  kn() {
    return ++this.Nn;
  }
...
var Kr = class {
  ...
  Fn(t2) {
    O2("LruGarbageCollector", `Garbage collection scheduled in ${t2}ms`), this.On = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", t2, async () => {
      this.On = null;
      try {
        await this.localStore.collectGarbage(this.garbageCollector);
      } catch (t3) {
        Nt(t3) ? O2("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t3) : await vt(t3);
      }
      await this.Fn(3e5);
    });
  }
...
var Gr = class {
  ...
  collect(t2, e) {
    return -1 === this.params.cacheSizeCollectionThreshold ? (O2("LruGarbageCollector", "Garbage collection skipped; disabled"), Vt.resolve(vr)) : this.getCacheSize(t2).next((n) => n < this.params.cacheSizeCollectionThreshold ? (O2("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), vr) : this.Un(t2, e));
  }
  getCacheSize(t2) {
...
var Qr = class {
  ...
  Gn(t2, e) {
    return function(t3, e2) {
      let n = false;
      return Mr(t3).tt((s) => xr(t3, s, e2).next((t4) => (t4 && (n = true), Vt.resolve(!t4)))).next(() => n);
    }(t2, e);
  }
  removeOrphanedDocuments(t2, e) {
  ...
  Kn(t2, e) {
    ...
    return n.Z({
      ...
      0 === t3 ? (i !== Lt.at && e(new dt(di(s)), i), i = o, s = r) : i = Lt.at;
    }).next(() => {
...
var zr = class {
  ...
  getAllFromCollection(t2, e, n) {
    ...
    return Xr(t2).W(IDBKeyRange.bound(s, i, true)).next((t3) => {
      let e2 = cs();
      for (const n2 of t3) {
        const t4 = this.jn(dt.fromSegments(n2.prefixPath.concat(n2.collectionGroup, n2.documentId)), n2);
  ...
  getAllFromCollectionGroup(t2, e, n, s) {
    ...
    return Xr(t2).Z({
      ...
      const r2 = this.jn(dt.fromSegments(e2.prefixPath.concat(e2.collectionGroup, e2.documentId)), e2);
  ...
  getMetadata(t2) {
    return Yr(t2).get("remoteDocumentGlobalKey").next((t3) => (U2(!!t3), t3));
  }
  Qn(t2, e) {
...
var Jr = class extends Wr {
  constructor(t2, e) {
    super(), this.Yn = t2, this.trackRemovals = e, this.Xn = new os((t3) => t3.toString(), (t3, e2) => t3.isEqual(e2));
  }
  applyChanges(t2) {
    const e = [];
    ...
    return this.changes.forEach((i, r) => {
      ...
      if (e.push(this.Yn.removeEntry(t2, i, o.readTime)), r.isValidDocument()) {
        ...
        const n2 = Qi(this.Yn.It, r.convertToNoDocument(ct.min()));
        e.push(this.Yn.addEntry(t2, i, n2));
      }
    }), s.forEach((n2) => {
      e.push(this.Yn.indexManager.addToCollectionParentIndex(t2, n2));
    }), e.push(this.Yn.updateMetadata(t2, n)), Vt.waitFor(e);
  }
  getFromCache(t2, e) {
...
var ro = class {
  ...
  removeOverlaysForBatchId(t2, e, n) {
    ...
    return void 0 !== s && (s.forEach((t3) => this.overlays = this.overlays.remove(t3)), this.es.delete(n)), Vt.resolve();
  }
  getOverlaysForCollection(t2, e, n) {
...
var mo = class {
  ...
  qs(t2) {
    ...
    return e.W().next((e2) => Vt.forEach(e2, (e3) => {
      const s = IDBKeyRange.bound([e3.userId, -1], [e3.userId, e3.lastAcknowledgedBatchId]);
      return n.W("userMutationsIndex", s).next((n2) => Vt.forEach(n2, (n3) => {
        U2(n3.userId === e3.userId);
        const s2 = Hi(this.It, n3);
  ...
  zs(t2, e) {
    ...
    return n.W().next((t3) => {
      ...
      return t3.forEach((t4) => {
        ...
        Hi(this.It, t4).keys().forEach((t5) => s2 = s2.add(t5)), n2.set(t4.userId, s2);
      }), Vt.forEach(n2, (t4, n3) => {
        const r = new C2(n3), o = rr.oe(this.It, r), u = i.getIndexManager(r), c = Cr.oe(r, this.It, u, i.referenceDelegate);
        return new so(s, c, o, u).recalculateAndSaveOverlaysForDocumentKeys(new Fi(e, Lt.at), t4).next();
      });
    });
  }
};
...
var yo = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.";
var po = class {
  constructor(t2, e, n, s, i, r, o, u, c, a, h = 15) {
    if (this.allowTabSynchronization = t2, this.persistenceKey = e, this.clientId = n, this.Hs = i, this.window = r, this.document = o, this.Js = c, this.Ys = a, this.Xs = h, this.Ss = null, this.Ds = false, this.isPrimary = false, this.networkEnabled = true, this.Zs = null, this.inForeground = false, this.ti = null, this.ei = null, this.ni = Number.NEGATIVE_INFINITY, this.si = (t3) => Promise.resolve(), !po.C())
    ...
    this.referenceDelegate = new Qr(this, s), this.ii = e + "main", this.It = new Ki(u), this.ri = new Dt(this.ii, this.Xs, new mo(this.It)), this.Cs = new Fr(this.referenceDelegate, this.It), this.remoteDocumentCache = Hr(this.It), this.Ns = new nr(), this.window && this.window.localStorage ? this.oi = this.window.localStorage : (this.oi = null, false === a && F2("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
  }
  start() {
    return this.ui().then(() => {
      if (!this.isPrimary && !this.allowTabSynchronization)
        throw new Q2(G.FAILED_PRECONDITION, yo);
  ...
  ui() {
    ...
    return Io(t2).get("owner").next((t3) => Vt.resolve(this.mi(t3)));
  }
  gi(t2) {
  ...
  di(t2) {
    ...
    return Io(t2).get("owner").next((e) => {
      ...
      return !(!this.networkEnabled || !this.inForeground) || To(t2).W().next((t3) => void 0 === this.Ii(t3, 5e3).find((t4) => {
  ...
  vi() {
    return this.runTransaction("getActiveClients", "readonly", (t2) => To(t2).W().next((t3) => this.Ii(t3, 18e5).map((t4) => t4.clientId)));
  }
  get started() {
    return this.Ds;
  }
  getMutationQueue(t2, e) {
    return Cr.oe(t2, this.It, e, this.referenceDelegate);
  }
  getTargetCache() {
    return this.Cs;
  }
  ...
  getIndexManager(t2) {
    return new Tr(t2, this.It.re.databaseId);
  }
  getDocumentOverlayCache(t2) {
    return rr.oe(this.It, t2);
  }
  getBundleCache() {
    return this.Ns;
  }
  runTransaction(t2, e, n) {
    ...
    const s = "readonly" === e ? "readonly" : "readwrite", i = 15 === (r = this.Xs) ? Oi : 14 === r ? Mi : 13 === r ? ki : 12 === r ? Ni : 11 === r ? xi : void L2();
    var r;
    let o;
    return this.ri.runTransaction(t2, s, i, (s2) => (o = new Fi(s2, this.Ss ? this.Ss.next() : Lt.at), "readwrite-primary" === e ? this.fi(o).next((t3) => !!t3 || this.di(o)).next((e2) => {
      if (!e2)
        throw F2(`Failed to obtain primary lease for action '${t2}'.`), this.isPrimary = false, this.Hs.enqueueRetryable(() => this.si(false)), new Q2(G.FAILED_PRECONDITION, bt);
      return n(o);
  ...
  _i(t2) {
    const e = Io(t2);
    return e.get("owner").next((t3) => this.mi(t3) ? (O2("IndexedDbPersistence", "Releasing primary lease."), e.delete("owner")) : Vt.resolve());
  }
  pi(t2, e) {
    const n = Date.now();
...
var Ro = class {
  ...
  Mi(t2, e, n, s) {
    return cn(e) || s.isEqual(ct.min()) ? this.Oi(t2, e) : this.Ni.getDocuments(t2, n).next((i) => {
      const r = this.Fi(e, i);
      return this.$i(e, r, n, s) ? this.Oi(t2, e) : (k2() <= LogLevel.DEBUG && O2("QueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), gn(e)), this.Bi(t2, r, e, Tt(s, -1)));
    });
  }
  Fi(t2, e) {
    let n = new Wt(In(t2));
...
var bo = class {
  constructor(t2, e, n, s) {
    this.persistence = t2, this.Li = e, this.It = s, this.Ui = new Gt(it), this.qi = new os((t3) => Fe(t3), Be), this.Ki = /* @__PURE__ */ new Map(), this.Gi = t2.getRemoteDocumentCache(), this.Cs = t2.getTargetCache(), this.Ns = t2.getBundleCache(), this.Qi(n);
  }
  Qi(t2) {
    ...
    return function(t4, e2, n2, s2) {
      ...
      return r.forEach((t5) => {
        o = o.next(() => s2.getEntry(e2, t5)).next((e3) => {
          ...
          U2(null !== r2), e3.version.compareTo(r2) < 0 && (i2.applyToRemoteDocument(e3, n2), e3.isValidDocument() && (e3.setReadTime(n2.commitVersion), s2.addEntry(e3)));
        });
...
function No(t2, e) {
  ...
  return n.persistence.runTransaction("Allocate target", "readwrite", (t3) => {
    let s;
    return n.Cs.getTargetData(t3, e).next((i) => i ? (s = i, Vt.resolve(s)) : n.Cs.allocateTargetId(t3).next((i2) => (s = new qi(e, i2, 0, t3.currentSequenceNumber), n.Cs.addTargetData(t3, s).next(() => s))));
  }).then((t3) => {
...
function Mo(t2, e, n) {
  ...
  return s.persistence.runTransaction("Execute query", "readonly", (t3) => function(t4, e2, n2) {
    const s2 = K2(t4), i2 = s2.qi.get(n2);
    return void 0 !== i2 ? Vt.resolve(s2.Ui.get(i2)) : s2.Cs.getTargetData(e2, n2);
  }(s, t3, dn(e)).next((e2) => {
    if (e2)
      return i = e2.lastLimboFreeSnapshotVersion, s.Cs.getMatchingKeysForTargetId(t3, e2.targetId).next((t4) => {
        r = t4;
      });
  }).next(() => s.Li.getDocumentsMatchingQuery(t3, e, n ? i : ct.min(), n ? r : gs())).next((t4) => ($o(s, pn(e), t4), {
    documents: t4,
    Hi: r
  })));
}
function Oo(t2, e) {
  const n = K2(t2), s = K2(n.Cs), i = n.Ui.get(e);
...
function Fo(t2, e) {
  const n = K2(t2), s = n.Ki.get(e) || ct.min();
...
async function Bo(t2, e, n, s) {
  ...
  return i.persistence.runTransaction("Apply bundle documents", "readwrite", (t3) => Co(t3, u, o).next((e2) => (u.apply(t3), e2)).next((e2) => i.Cs.removeMatchingKeysForTargetId(t3, c.targetId).next(() => i.Cs.addMatchingKeys(t3, r, c.targetId)).next(() => i.localDocuments.getLocalViewOfDocuments(t3, e2.Wi, e2.zi)).next(() => e2.Wi)));
}
async function Lo(t2, e, n = gs()) {
  const s = await No(t2, dn(Xi(e.bundledQuery))), i = K2(t2);
...
var Go = class {
  ...
  static Zi(t2, e, n) {
    ...
    return r && s.error && (r = "string" == typeof s.error.message && "string" == typeof s.error.code, r && (i = new Q2(s.error.code, s.error.message))), r ? new Go(t2, e, s.state, i) : (F2("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), null);
  }
  tr() {
    const t2 = {
      state: this.state,
...
var Qo = class {
  ...
  static Zi(t2, e) {
    ...
    return i && n.error && (i = "string" == typeof n.error.message && "string" == typeof n.error.code, i && (s = new Q2(n.error.code, n.error.message))), i ? new Qo(t2, n.state, s) : (F2("SharedClientState", `Failed to parse target state for ID '${t2}': ${e}`), null);
  }
  tr() {
    const t2 = {
      state: this.state,
...
var jo = class {
  ...
  static Zi(t2, e) {
    ...
    return s ? new jo(t2, i) : (F2("SharedClientState", `Failed to parse client data for instance '${t2}': ${e}`), null);
  }
};
var Wo = class {
  constructor(t2, e) {
  ...
  static Zi(t2) {
    ...
    return "object" == typeof e && -1 !== ["Unknown", "Online", "Offline"].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Wo(e.clientId, e.onlineState) : (F2("SharedClientState", `Failed to parse online state: ${t2}`), null);
  }
};
var zo = class {
  constructor() {
...
var Ho = class {
  constructor(t2, e, n, s, i) {
    this.window = t2, this.Hs = e, this.persistenceKey = n, this.sr = s, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.ir = this.rr.bind(this), this.ur = new Gt(it), this.started = false, this.cr = [];
    const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.ar = Uo(this.persistenceKey, this.sr), this.hr = function(t3) {
      return `firestore_sequence_number_${t3}`;
    }(this.persistenceKey), this.ur = this.ur.insert(this.sr, new zo()), this.lr = new RegExp(`^firestore_clients_${r}_([^_]*)$`), this.dr = new RegExp(`^firestore_mutations_${r}_(\\d+)(?:_(.*))?$`), this._r = new RegExp(`^firestore_targets_${r}_(\\d+)$`), this.wr = function(t3) {
  ...
  rr(t2) {
    ...
    if (e.storageArea === this.storage) {
      if (O2("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.ar)
...
var eu = class extends class {
  ...
  co(t2, e, n, s, i) {
    ...
    const o = {};
    return this.ho(o, s, i), this.lo(t2, r, o, n).then((t3) => (O2("RestConnection", "Received: ", t3), t3), (e2) => {
...
var ru = class {
  ...
  Ao(t2) {
    ...
    s > 0 && O2("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.po} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), this.Io = this.Hs.enqueueAfterDelay(this.timerId, s, () => (this.To = Date.now(), t2())), this.po *= this.mo, this.po < this.wo && (this.po = this.wo), this.po > this.yo && (this.po = this.yo);
  }
  bo() {
...
var ou = class {
  constructor(t2, e, n, s, i, r, o, u) {
    this.Hs = t2, this.Po = n, this.vo = s, this.Vo = i, this.authCredentialsProvider = r, this.appCheckCredentialsProvider = o, this.listener = u, this.state = 0, this.So = 0, this.Do = null, this.Co = null, this.stream = null, this.xo = new ru(t2, e);
  }
  No() {
...
var cu = class extends ou {
  ...
  onMessage(t2) {
    if (U2(!!t2.streamToken), this.lastStreamToken = t2.streamToken, this.Jo) {
      this.xo.reset();
      const e = Js(t2.writeResults, t2.commitTime), n = Ms(t2.commitTime);
      return this.listener.Zo(n, e);
    }
    return U2(!t2.writeResults || 0 === t2.writeResults.length), this.Jo = true, this.listener.tu();
  }
  eu() {
    const t2 = {};
...
function wu(t2, e) {
  const n = K2(t2), s = $u(n);
  n.du.delete(e), s.ko() && gu(n, e), 0 === n.du.size && (s.ko() ? s.Fo() : Iu(n) && n.gu.set("Unknown"));
}
function mu(t2, e) {
...
async function ku(t2, e, n) {
  const s = t2.fu.shift(), i = Li.from(s, e, n);
...
async function Mu(t2, e) {
  e && Bu(t2).Yo && await async function(t3, e2) {
    if (n = e2.code, is(n) && n !== G.ABORTED) {
      ...
      Bu(t3).Oo(), await Pu(t3, () => t3.remoteSyncer.rejectFailedWrite(n2.batchId, e2)), await vu(t3);
    }
    var n;
  }(t2, e), Du(t2) && Cu(t2);
}
async function Ou(t2, e) {
  ...
  const s = Iu(n);
  n._u.add(3), await du(n), s && n.gu.set("Unknown"), await n.remoteSyncer.handleCredentialChange(e), n._u.delete(3), await fu(n);
}
...
function Bu(t2) {
  return t2.Iu || (t2.Iu = function(t3, e, n) {
    ...
    e ? (t2.Iu.Oo(), await vu(t2)) : (await t2.Iu.stop(), t2.fu.length > 0 && (O2("RemoteStore", `Stopping write stream with ${t2.fu.length} pending writes`), t2.fu = []));
  })), t2.Iu;
}
var Lu = class {
  constructor(t2, e, n, s, i) {
...
var tc2 = class {
  ...
  Ji(t2) {
    return Bs(this.It, t2);
  }
  Yi(t2) {
    return t2.metadata.exists ? Qs(this.It, t2.document, false) : ke.newNoDocument(this.Ji(t2.metadata.name), this.Xi(t2.metadata.readTime));
  }
  Xi(t2) {
    return Ms(t2);
  }
...
var ec2 = class {
  constructor(t2, e, n) {
    this.Mu = t2, this.localStore = e, this.It = n, this.queries = [], this.documents = [], this.collectionGroups = /* @__PURE__ */ new Set(), this.progress = nc2(t2);
  }
  Ou(t2) {
  ...
  Fu(t2) {
    const e = /* @__PURE__ */ new Map(), n = new tc2(this.It);
    for (const s of t2)
  ...
  async complete() {
    const t2 = await Bo(this.localStore, new tc2(this.It), this.documents, this.Mu.id), e = this.Fu(this.documents);
...
async function ac2(t2, e) {
  ...
  if (r)
    ...
    s = t3.targetId, i = await hc2(n, e, s, "current" === r2);
  }
  return i;
}
async function hc2(t2, e, n, s) {
  ...
  const i = await Mo(
    ...
    e,
    true
  ), r = new rc2(e, i.Hi), o = r.ju(i.documents), u = Ts.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" !== t2.onlineState), c = r.applyChanges(
    o,
    t2.isPrimaryClient,
    u
  );
...
async function lc2(t2, e) {
  const n = K2(t2), s = n.sc.get(e), i = n.ic.get(s.targetId);
  if (i.length > 1)
    return n.ic.set(s.targetId, i.filter((t3) => !wn(t3, e))), void n.sc.delete(e);
  if (n.isPrimaryClient) {
    ...
    n.sharedClientState.isActiveQueryTarget(s.targetId) || await ko(
      ...
      n.sharedClientState.clearQueryState(s.targetId), wu(n.remoteStore, s.targetId), Tc2(n, s.targetId);
    }).catch(vt);
  } else
    Tc2(n, s.targetId), await ko(
      n.localStore,
      s.targetId,
      true
    );
...
async function fc2(t2, e, n) {
  ...
  try {
    const t3 = await function(t4, e2) {
      const n2 = K2(t4), s2 = ut.now(), i = e2.reduce((t5, e3) => t5.add(e3.key), gs());
      let r, o;
    ...
    }(s, t3.batchId, n), await Pc2(s, t3.changes), await vu(s.remoteStore);
  } catch (t3) {
...
async function dc2(t2, e) {
  ...
  try {
    ...
    e.targetChanges.forEach((t4, e2) => {
      const s = n.uc.get(e2);
      s && (U2(t4.addedDocuments.size + t4.modifiedDocuments.size + t4.removedDocuments.size <= 1), t4.addedDocuments.size > 0 ? s.ec = true : t4.modifiedDocuments.size > 0 ? U2(s.ec) : t4.removedDocuments.size > 0 && (U2(s.ec), s.ec = false));
    }), await Pc2(n, t3, e);
  } catch (t3) {
    await vt(t3);
  }
...
async function wc2(t2, e, n) {
  ...
  if (r) {
    ...
    await dc2(s, i2), s.oc = s.oc.remove(r), s.uc.delete(e), bc2(s);
  } else
    await ko(
      s.localStore,
      e,
      false
    ).then(() => Tc2(s, e, n)).catch(vt);
}
async function mc2(t2, e) {
  const n = K2(t2), s = e.batch.batchId;
  try {
    const t3 = await Vo(n.localStore, e);
    Ic2(n, s, null), pc2(n, s), n.sharedClientState.updateMutationState(s, "acknowledged"), await Pc2(n, t3);
  } catch (t3) {
    await vt(t3);
  }
}
async function gc2(t2, e, n) {
  const s = K2(t2);
  try {
    const t3 = await function(t4, e2) {
      const n2 = K2(t4);
      return n2.persistence.runTransaction("Reject batch", "readwrite-primary", (t5) => {
        let s2;
        return n2.mutationQueue.lookupMutationBatch(t5, e2).next((e3) => (U2(null !== e3), s2 = e3.keys(), n2.mutationQueue.removeMutationBatch(t5, e3))).next(() => n2.mutationQueue.performConsistencyCheck(t5)).next(() => n2.documentOverlayCache.removeOverlaysForBatchId(t5, s2, e2)).next(() => n2.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(t5, s2)).next(() => n2.localDocuments.getDocuments(t5, s2));
      });
    }(s.localStore, e);
    Ic2(s, e, n), pc2(s, e), s.sharedClientState.updateMutationState(e, "rejected", n), await Pc2(s, t3);
  } catch (n2) {
    await vt(n2);
  }
}
async function yc2(t2, e) {
  const n = K2(t2);
  Iu(n.remoteStore) || O2("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
  try {
...
function Ac2(t2, e, n) {
  for (const s of n)
    if (s instanceof sc2)
      t2.cc.addReference(s.key, e), Rc2(t2, s);
    else if (s instanceof ic2) {
      O2("SyncEngine", "Document no longer in limbo: " + s.key), t2.cc.removeReference(s.key, e);
      t2.cc.containsKey(s.key) || Ec2(t2, s.key);
    } else
      L2();
}
function Rc2(t2, e) {
  const n = e.key, s = n.path.canonicalString();
  t2.oc.get(n) || t2.rc.has(s) || (O2("SyncEngine", "New document in limbo: " + n), t2.rc.add(s), bc2(t2));
}
function bc2(t2) {
  for (; t2.rc.size > 0 && t2.oc.size < t2.maxConcurrentLimboResolutions; ) {
    const e = t2.rc.values().next().value;
    t2.rc.delete(e);
    const n = new dt(ht.fromString(e)), s = t2.lc.next();
    t2.uc.set(s, new uc2(n)), t2.oc = t2.oc.insert(n, s), _u(t2.remoteStore, new qi(dn(un(n.path)), s, 2, Lt.at));
  }
}
async function Pc2(t2, e, n) {
  ...
  s.sc.isEmpty() || (s.sc.forEach((t3, u) => {
    ...
    const n2 = K2(t3);
    try {
      await n2.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (t4) => Vt.forEach(e2, (e3) => Vt.forEach(e3.Si, (s2) => n2.persistence.referenceDelegate.addReference(t4, e3.targetId, s2)).next(() => Vt.forEach(e3.Di, (s2) => n2.persistence.referenceDelegate.removeReference(t4, e3.targetId, s2)))));
    } catch (t4) {
      if (!Nt(t4))
        throw t4;
...
async function Sc2(t2, e) {
  const n = K2(t2), s = await Mo(
    n.localStore,
    e.query,
    true
  ), i = e.view.Zu(s);
  return n.isPrimaryClient && Ac2(n, e.targetId, i.Yu), i;
}
async function Dc2(t2, e) {
  const n = K2(t2);
  return Fo(n.localStore, e).then((t3) => Pc2(n, t3));
}
async function Cc2(t2, e, n, s) {
  const i = K2(t2), r = await function(t3, e2) {
    const n2 = K2(t3), s2 = K2(n2.mutationQueue);
    return n2.persistence.runTransaction("Lookup mutation documents", "readonly", (t4) => s2.Tn(t4, e2).next((e3) => e3 ? n2.localDocuments.getDocuments(t4, e3) : Vt.resolve(null)));
  }(i.localStore, e);
  null !== r ? ("pending" === n ? await vu(i.remoteStore) : "acknowledged" === n || "rejected" === n ? (Ic2(i, e, s || null), pc2(i, e), function(t3, e2) {
    K2(K2(t3).mutationQueue).An(e2);
  }(i.localStore, e)) : L2(), await Pc2(i, r)) : O2("SyncEngine", "Cannot apply mutation batch with id: " + e);
}
async function xc2(t2, e) {
  const n = K2(t2);
  if ($c2(n), Bc2(n), true === e && true !== n.fc) {
    const t3 = n.sharedClientState.getAllActiveQueryTargets(), e2 = await Nc2(n, t3.toArray());
    n.fc = true, await Fu(n.remoteStore, true);
    for (const t4 of e2)
      _u(n.remoteStore, t4);
    ...
    n.ic.forEach((s, i) => {
      n.sharedClientState.isLocalQueryTarget(i) ? t3.push(i) : e2 = e2.then(() => (Tc2(n, i), ko(
        n.localStore,
        i,
        true
      ))), wu(n.remoteStore, i);
    }), await e2, await Nc2(n, t3), function(t4) {
      const e3 = K2(t4);
      e3.uc.forEach((t5, n2) => {
        wu(e3.remoteStore, n2);
      }), e3.cc.fs(), e3.uc = /* @__PURE__ */ new Map(), e3.oc = new Gt(dt.comparator);
    }(n), n.fc = false, await Fu(n.remoteStore, false);
  }
}
async function Nc2(t2, e, n) {
  ...
  for (const t3 of e) {
    ...
    if (n2 && 0 !== n2.length) {
      ...
      for (const t4 of n2) {
        const e3 = s.sc.get(t4), n3 = await Sc2(s, e3);
        n3.snapshot && r.push(n3.snapshot);
      }
    } else {
      const n3 = await Oo(s.localStore, t3);
      e2 = await No(s.localStore, n3), await hc2(
        s,
        kc2(n3),
        t3,
        false
...
function Mc2(t2) {
  const e = K2(t2);
  return K2(K2(e.localStore).persistence).vi();
}
async function Oc2(t2, e, n, s) {
  const i = K2(t2);
  if (i.fc)
...
async function Fc2(t2, e, n) {
  ...
  if (s.fc) {
    ...
    for (const t3 of n)
      s.ic.has(t3) && await ko(
        s.localStore,
        t3,
        false
      ).then(() => {
        wu(s.remoteStore, t3), Tc2(s, t3);
      }).catch(vt);
  }
}
function $c2(t2) {
...
function Bc2(t2) {
  const e = K2(t2);
  return e.remoteStore.remoteSyncer.applySuccessfulWrite = mc2.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = gc2.bind(null, e), e;
}
function Lc2(t2, e, n) {
  const s = K2(t2);
  (async function(t3, e2, n2) {
    try {
      ...
      n2._updateProgress(nc2(s2));
      const i = new ec2(s2, t3.localStore, e2.It);
      let r = await e2.wc();
      for (; r; ) {
...
var qc2 = class extends Uc2 {
  constructor(t2, e, n) {
    super(), this.Ec = t2, this.cacheSizeBytes = e, this.forceOwnership = n, this.synchronizeTabs = false;
  }
  async initialize(t2) {
    await super.initialize(t2), await this.Ec.initialize(this, t2), await Bc2(this.Ec.syncEngine), await vu(this.Ec.remoteStore), await this.persistence.li(() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve()));
  }
  yc(t2) {
    return Po(this.persistence, new Ro(), t2.initialUser, this.It);
  }
  ...
  gc(t2) {
    ...
    return new po(this.synchronizeTabs, e, t2.clientId, n, t2.asyncQueue, nu(), su(), this.It, this.sharedClientState, !!this.forceOwnership);
  }
  mc(t2) {
    return new Jo();
  }
};
var Kc2 = class extends qc2 {
  constructor(t2, e) {
  ...
  async initialize(t2) {
    ...
    this.sharedClientState instanceof Ho && (this.sharedClientState.syncEngine = {
      ...
      await xc2(this.Ec.syncEngine, t3), this.gcScheduler && (t3 && !this.gcScheduler.started ? this.gcScheduler.start() : t3 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (t3 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : t3 || this.indexBackfillerScheduler.stop());
    });
  }
  mc(t2) {
    const e = nu();
...
var Gc2 = class {
  ...
  createRemoteStore(t2) {
    return e = this.localStore, n = this.datastore, s = t2.asyncQueue, i = (t3) => _c(this.syncEngine, t3, 0), r = Xo.C() ? new Xo() : new Yo(), new lu(e, n, s, i, r);
    var e, n, s, i, r;
  }
...
var Wc2 = class {
  constructor(t2, e) {
    this.bc = t2, this.It = e, this.metadata = new j(), this.buffer = new Uint8Array(), this.Pc = new TextDecoder("utf-8"), this.vc().then((t3) => {
...
var zc2 = class {
  ...
  async lookup(t2) {
    ...
    const e = await async function(t3, e2) {
      const n = K2(t3), s = qs(n.It) + "/documents", i = {
        documents: e2.map((t4) => $s(n.It, t4))
  ...
  precondition(t2) {
    ...
    return !this.writtenDocs.has(t2.toString()) && e ? e.isEqual(ct.min()) ? Ln.exists(false) : Ln.updateTime(e) : Ln.none();
  }
...
var Hc2 = class {
  constructor(t2, e, n, s, i) {
    this.asyncQueue = t2, this.datastore = e, this.options = n, this.updateFunction = s, this.deferred = i, this.Nc = n.maxAttempts, this.xo = new ru(this.asyncQueue, "transaction_retry");
  }
  run() {
    this.Nc -= 1, this.kc();
  }
  kc() {
    this.xo.Ao(async () => {
      const t2 = new zc2(this.datastore), e = this.Mc(t2);
      e && e.then((e2) => {
...
var Jc2 = class {
  constructor(t2, e, n, s) {
    this.authCredentials = t2, this.appCheckCredentials = e, this.asyncQueue = n, this.databaseInfo = s, this.user = C2.UNAUTHENTICATED, this.clientId = st.R(), this.authCredentialListener = () => Promise.resolve(), this.appCheckCredentialListener = () => Promise.resolve(), this.authCredentials.start(n, async (t3) => {
...
function ea2(t2) {
  return Zc2(t2).then((t3) => t3.persistence);
}
function na2(t2) {
  return Zc2(t2).then((t3) => t3.localStore);
}
function sa2(t2) {
  return ta2(t2).then((t3) => t3.remoteStore);
}
function ia2(t2) {
  return ta2(t2).then((t3) => t3.syncEngine);
}
...
function oa2(t2) {
  return t2.asyncQueue.enqueue(async () => {
    const e = await ea2(t2), n = await sa2(t2);
    return e.setNetworkEnabled(true), function(t3) {
      const e2 = K2(t3);
      return e2._u.delete(0), fu(e2);
    }(n);
  });
}
function ua2(t2) {
  return t2.asyncQueue.enqueue(async () => {
    ...
    return e.setNetworkEnabled(false), async function(t3) {
      const e2 = K2(t3);
      e2._u.add(0), await du(e2), e2.gu.set("Offline");
    }(n);
  });
}
function ca(t2, e) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => async function(t3, e2, n2) {
    try {
      const s = await Mo(
        ...
        e2,
        true
      ), i = new rc2(e2, s.Hi), r = i.ju(s.documents), o = i.applyChanges(
        r,
        false
      );
...
function la2(t2, e, n = {}) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => function(t3, e2, n2, s2, i) {
    const r = new jc2({
      next: (n3) => {
        e2.enqueueAndForget(() => zu(t3, o)), n3.fromCache && "server" === s2.source ? i.reject(new Q2(G.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n3);
      },
      error: (t4) => i.reject(t4)
    }), o = new Xu(n2, r, {
      includeMetadataChanges: true,
...
function da2(t2, e, n) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => {
    const i = await function(t3) {
      return ta2(t3).then((t4) => t4.datastore);
    }(t2);
    new Hc2(t2.asyncQueue, i, n, e, s).run();
  }), s.promise;
}
function _a(t2, e, n, s) {
  const i = function(t3, e2) {
    ...
    return function(t4, e3) {
      return new Wc2(t4, e3);
    }(function(t4, e3) {
      if (t4 instanceof Uint8Array)
        return Qc2(t4, e3);
      if (t4 instanceof ArrayBuffer)
        return Qc2(new Uint8Array(t4), e3);
...
var ba2 = class {
  constructor(t2, e, n, s) {
    this._authCredentials = t2, this._appCheckCredentials = e, this._databaseId = n, this._app = s, this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new Ra2({}), this._settingsFrozen = false;
  }
  get app() {
    if (!this._app)
...
function Pa(t2, e, n, s = {}) {
  var i;
  const r = (t2 = Ea(t2, ba2))._getSettings();
...
function Da(t2, e, ...n) {
  if (t2 = getModularInstance(t2), ga("collection", "path", e), t2 instanceof ba2) {
    ...
    return Ia2(s), new Sa2(t2, null, s);
  }
  {
...
function Ca2(t2, e) {
  if (t2 = Ea(t2, ba2), ga("collectionGroup", "collection id", e), e.indexOf("/") >= 0)
...
function ka2(t2, e) {
  return t2 = getModularInstance(t2), e = getModularInstance(e), t2 instanceof Va2 && e instanceof Va2 && (t2.firestore === e.firestore && wn(t2._query, e._query) && t2.converter === e.converter);
}
var Ma2 = class {
  constructor() {
  ...
  enqueueAfterDelay(t2, e, n) {
    ...
    const s = Lu.createAndSchedule(this, t2, e, n, (t3) => this.Jc(t3));
...
var $a2 = -1;
var Ba = class extends ba2 {
  constructor(t2, e, n, s) {
    super(t2, e, n, s), this.type = "firestore", this._queue = new Ma2(), this._persistenceKey = (null == s ? void 0 : s.name) || "[DEFAULT]";
  }
  _terminate() {
...
function Ka2(t2) {
  ...
  t2._firestoreClient = new Jc2(t2._authCredentials, t2._appCheckCredentials, t2._queue, s);
}
function Ga2(t2, e) {
  th(t2 = Ea(t2, Ba));
  const n = qa2(t2), s = t2._freezeSettings(), i = new Gc2();
  return ja2(n, i, new qc2(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
function Qa(t2) {
  th(t2 = Ea(t2, Ba));
  const e = qa2(t2), n = t2._freezeSettings(), s = new Gc2();
  return ja2(e, s, new Kc2(s, n.cacheSizeBytes));
}
function ja2(t2, e, n) {
  const s = new j();
  return t2.asyncQueue.enqueue(async () => {
    try {
      await Yc2(t2, n), await Xc2(t2, e), s.resolve();
    } catch (t3) {
      const e2 = t3;
      if (!function(t4) {
...
function za2(t2) {
  return function(t3) {
    const e = new j();
    return t3.asyncQueue.enqueueAndForget(async () => yc2(await ia2(t3), e)), e.promise;
  }(qa2(t2 = Ea(t2, Ba)));
}
function Ha2(t2) {
  return oa2(qa2(t2 = Ea(t2, Ba)));
}
function Ja2(t2) {
  return ua2(qa2(t2 = Ea(t2, Ba)));
}
function Ya2(t2) {
  return _removeServiceInstance(t2.app, "firestore", t2._databaseId.database), t2._delete();
}
function Xa2(t2, e) {
  const n = qa2(t2 = Ea(t2, Ba)), s = new Fa2();
  return _a(n, t2._databaseId, e, s), s;
}
function Za2(t2, e) {
  return wa(qa2(t2 = Ea(t2, Ba)), e).then((e2) => e2 ? new Va2(t2, null, e2.query) : null);
}
function th(t2) {
  if (t2._initialized || t2._terminated)
...
var gh = class extends ih {
  ...
  _toFieldTransform(t2) {
    const e = wh(
      ...
      t2,
      true
    ), n = this.da.map((t3) => Ah(t3, e)), s = new Dn(n);
...
var yh = class extends ih {
  ...
  _toFieldTransform(t2) {
    const e = wh(
      ...
      t2,
      true
    ), n = this.da.map((t3) => Ah(t3, e)), s = new xn(n);
    return new Fn(t2.path, s);
  }
  isEqual(t2) {
    return this === t2;
...
var ph = class extends ih {
  ...
  _toFieldTransform(t2) {
    const e = new kn(t2.It, Rn(t2.It, this._a));
...
function Th(t2, e, n, s, i, r) {
  const o = t2.fa(1, e, n), u = [vh(e, s, n)], c = [i];
  if (r.length % 2 != 0)
...
function Jh(t2) {
  return Aa2("limitToLast", t2), new zh("limitToLast", t2, "L");
}
var Yh = class extends qh {
  ...
  _apply(t2) {
    const e = sl(t2, this.type, this.Ta, this.Ea);
    return new Va2(t2.firestore, t2.converter, function(t3, e2) {
...
function wl(t2) {
  t2 = Ea(t2, va);
  const e = Ea(t2.firestore, Ba), n = qa2(e), s = new _l(e);
...
function gl(t2) {
  t2 = Ea(t2, Va2);
  const e = Ea(t2.firestore, Ba), n = qa2(e), s = new _l(e);
  return Uh(t2._query), la2(n, t2._query).then((n2) => new $h(e, s, t2, n2));
}
function yl(t2) {
  t2 = Ea(t2, Va2);
  const e = Ea(t2.firestore, Ba), n = qa2(e), s = new _l(e);
  return ha2(n, t2._query).then((n2) => new $h(e, s, t2, n2));
}
function pl(t2) {
  t2 = Ea(t2, Va2);
  const e = Ea(t2.firestore, Ba), n = qa2(e), s = new _l(e);
  return la2(n, t2._query, {
    source: "server"
...
function Al(t2, e) {
  const n = Ea(t2.firestore, Ba), s = xa2(t2), i = al(t2.converter, e);
...
function Rl(t2, ...e) {
  ...
  return function(t3, e2, n2, s2) {
    const i2 = new jc2(s2), r2 = new Xu(e2, i2, n2);
...
function bl(t2, e) {
  return fa2(qa2(t2 = Ea(t2, Ba)), Oa(e) ? e : {
    next: e
  });
}
function Pl(t2, e) {
  return function(t3, e2) {
    const n = new j();
    return t3.asyncQueue.enqueueAndForget(async () => fc2(await ia2(t3), e2, n)), n.promise;
  }(qa2(t2), e);
}
function vl(t2, e, n) {
...
function Sl(t2, e, n) {
  ...
  return da2(qa2(t2), (n2) => e(new Vl(t2, n2)), s);
}
function Dl() {
...
function Ml(t2) {
  return qa2(t2 = Ea(t2, Ba)), new ll(t2, (e) => Pl(t2, e));
}
function Ol(t2, e) {
  var n;
  const s = qa2(t2 = Ea(t2, Ba));
  ...
  const i = function(t3) {
    const e2 = "string" == typeof t3 ? function(t4) {
      ...
      try {
        ...
        throw new Q2(G.INVALID_ARGUMENT, "Failed to parse JSON: " + (null === (e3 = t5) || void 0 === e3 ? void 0 : e3.message));
      }
    }(t3) : t3, n2 = [];
  ...
  return na2(s).then((t3) => async function(t4, e2) {
    const n2 = K2(t4), s2 = n2.indexManager, i2 = [];
...
export {
  ...
  Nl as arrayRemove,
  xl as arrayUnion,
  Wa2 as clearIndexedDbPersistence,
  Da as collection,
  ...
  xa2 as doc,
  nh as documentId,
  Ga2 as enableIndexedDbPersistence,
